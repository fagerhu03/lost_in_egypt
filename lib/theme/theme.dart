...
class AppColors {
  // LIGHT MODE
  static const Color lightBackground = Color(0xFFFCFBE8);
  static const Color lightPatternOverlay = Color(0xFFE8E2C8);
  ...
  // DARK MODE
  static const Color darkBackground = Color(0xFF0B1D26);
  static const Color darkPatternOverlay = Color(0xFF112B36);
